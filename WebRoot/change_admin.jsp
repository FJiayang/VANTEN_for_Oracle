		...
		<div class="row">
			...
			<div class="col-sm-12 col-lg-9 col-md-9">
				<form class="form-horizontal" role="form" id="edit_admin"
					name="edit_admin" action="edit_admin.jsp" method="post">
					<div class="form-group">
						<label for="inputText1" class="col-sm-2 control-label">要修改的管理员姓名</label>
						<div class="col-sm-10">
							<select name="AdminName" class="form-control" name="AdminName">
								<%
